    ...
    extend: {
      ...
      colors: {
        ...
        room: {
          ...
          "available-light": "hsl(var(--room-available-light))",
          occupied: "hsl(var(--room-occupied))",
          "occupied-light": "hsl(var(--room-occupied-light))",
          booked: "hsl(var(--room-booked))",
          "booked-light": "hsl(var(--room-booked-light))",
        },
        sidebar: {
